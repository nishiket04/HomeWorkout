...
public class FilterEquipmentRecyclerViewAdapter extends RecyclerView.Adapter<FilterEquipmentRecyclerViewAdapter.viewHolder> {

    private List<FilterModel> filterModelList;
    private Context context;

    public FilterEquipmentRecyclerViewAdapter(Context context) {
    ...
    @NonNull
    @Override
    public FilterEquipmentRecyclerViewAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.filter_design,parent,false);
        return new viewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FilterEquipmentRecyclerViewAdapter.viewHolder holder, int position) {
